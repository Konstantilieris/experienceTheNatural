  ...
  return (
    <>
      ...
      <motion.button
        ...
        exit={{ opacity: 0, y: 8 }}
        className="absolute bottom-2 right-2 flex items-center gap-2 rounded-full bg-light-900 px-3 py-3 text-4xl uppercase text-dark-100 transition-colors hover:bg-white hover:text-violet-600 md:bottom-4 md:right-4 md:px-6 md:text-2xl"
      >
